...
term() {
    ...
    # oc --kubeconfig $kubeconfig --namespace openshift-ovn-kubernetes exec $capturePod1 -- cat /tmp/tcpdump-$podOne.tgz > ./local-tcpdump-$podOne.tgz
    ...
    # oc --kubeconfig $kubeconfig --namespace openshift-ovn-kubernetes exec $capturePod2 -- cat /tmp/tcpdump-$podTwo.tgz > ./local-tcpdump-$podTwo.tgz
